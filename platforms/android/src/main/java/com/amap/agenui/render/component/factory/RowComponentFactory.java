...
import com.amap.agenui.render.component.impl.RowComponent;

import java.util.Map;

@BuiltInComponent
public class RowComponentFactory implements IComponentFactory {
    
    @Override
    public A2UIComponent createComponent(Context context, String id, Map<String, Object> properties) {
        return new RowComponent(context, id, properties);
    }
